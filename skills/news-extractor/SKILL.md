...
```bash
cd C:/Users/TIAN/.config/opencode/skills/news-extractor
uv sync
```

> **说明**: 此 skill 位于用户级目录 `~/.config/opencode/skills/` 下。
...
uv run C:/Users/TIAN/.config/opencode/skills/news-extractor/scripts/extract_news.py "URL"

# 指定输出目录
uv run C:/Users/TIAN/.config/opencode/skills/news-extractor/scripts/extract_news.py "URL" --output ./output

# 仅输出 JSON
uv run C:/Users/TIAN/.config/opencode/skills/news-extractor/scripts/extract_news.py "URL" --format json

# 仅输出 Markdown
uv run C:/Users/TIAN/.config/opencode/skills/news-extractor/scripts/extract_news.py "URL" --format markdown

# 列出支持的平台
uv run C:/Users/TIAN/.config/opencode/skills/news-extractor/scripts/extract_news.py --list-platforms
```
...
```bash
uv run C:/Users/TIAN/.config/opencode/skills/news-extractor/scripts/extract_news.py \
